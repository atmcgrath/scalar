    ...
    $.scalarpage = function(e, options) {
        ...
        var page = {
            ...
            addColophon: function() {
                ...
                $par.append('<a href="http://scalar.usc.edu/scalar"><img src="' + page.options.root_url + '/images/scalar_logo_small.png" alt="Scalar" width="18" height="16"/></a>');
            ...
            setupScreenedBackground: function() {
                var screen = $('<div class="bg_screen"><img src="' + page.options.root_url + '/images/1x1white_trans.png" alt='' width="100%" height="100%"/></div>').prependTo('body');
